...
try:
    ...
    logger.info(f"customtkinter imported successfully (v{customtkinter.__version__ if hasattr(customtkinter, '__version__') else 'unknown'})")
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        try:
            ...
            icon_paths = [
                os.path.expanduser("~/.local/share/icons/hicolor/128x128/apps/mychatui.png"),
                os.path.expanduser("~/.local/share/mychatui.app/share/icons/hicolor/128x128/apps/jarvis128.png"),
